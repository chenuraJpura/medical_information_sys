...
public class medicalOfficers extends userController{
    ...
    public medicalOfficers(int medicalStaffID, String medicalStaffEmail, String userName, String userFirstName, String userLastName, int userPhoneNo, String userNIC, date userDOB, String userAddress) {
